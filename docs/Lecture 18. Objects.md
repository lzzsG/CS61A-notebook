...
title: L18 Objects
permalink: /L18
description: "Lecture 18. Objects 本节开始学习面向对象编程（Object-Oriented Programming, OOP），这是一种新的编程方法，包含一些新的概念和语法。不过，很多基础概念你已经有所接触，比如数据抽象和数据变异。此外，还会介绍新的概念，比如继承"
nav_order: 18
...
今天我们开始学习**面向对象编程（Object-Oriented Programming, OOP）**，这是一种新的编程方法，包含一些新的概念和语法。不过，很多基础概念你已经有所接触，比如**数据抽象**和**数据变异**。此外，还会介绍新的概念，比如**继承**。由于内容较多，建议你多花时间练习实验中的问题，并为下周发布的与面向对象编程相关的项目分配足够的时间。
