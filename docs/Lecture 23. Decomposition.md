---
layout: page
title: L23 Decomposition
permalink: /L23
description: "Lecture 23. Decomposition 本节内容关于分解（Decomposition），介绍了如何将大程序拆解为更小、更独立的模块，以实现复杂程序的功能。模块化设计的目标是通过分离关注点（Separation of Concerns）来减少系统各部分的依赖性，从而简化复杂系统的管理和扩展。"
nav_order: 23
...
今天的内容关于**分解**（Decomposition），介绍了如何将大程序拆解为更小、更独立的模块，以实现复杂程序的功能。模块化设计的目标是通过分离关注点（Separation of Concerns）来减少系统各部分的依赖性，从而简化复杂系统的管理和扩展。
...
![QQ_1726540268488]({{ site.baseurl }}/docs/assets/QQ_1726540268488.png)
